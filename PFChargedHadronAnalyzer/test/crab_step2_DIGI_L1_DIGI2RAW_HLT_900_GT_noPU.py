...
config.General.requestName = 'PGun_step2_DIGI_900_auto_phase1_Mar_23_FULL'
...
config.JobType.psetName = 'step2_DIGI_L1_DIGI2RAW_HLT_900.py'
...
config.Data.userInputFiles = open('/afs/cern.ch/work/s/spandey/public/PFHadronCalibration/CMSSW_9_0_0/src/PFCalibration/PFChargedHadronAnalyzer/test/step1_file_list.txt').readlines()
...
config.Data.outLFNDirBase = '/store/user/spandey/PGun_step2_DIGI_900_auto_phase1_Mar_23_FULL/'
