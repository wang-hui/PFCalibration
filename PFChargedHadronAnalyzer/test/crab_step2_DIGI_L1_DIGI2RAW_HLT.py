...
config.General.requestName = 'PGun_step2_DIGI_1200_2021_2_200_Sep17'
...
#config.Data.userInputFiles = open('/afs/cern.ch/user/b/bkansal/work/PFcalibration_run3/CMSSW_12_0_0/src/PFCalibration/PFChargedHadronAnalyzer/test/step1_input0.txt').readlines()
config.Data.userInputFiles = open('/afs/cern.ch/user/b/bkansal/work/PFcalibration_run3/CMSSW_12_0_0/src/PFCalibration/PFChargedHadronAnalyzer/test/step1_2_200_10million_1200.txt').readlines()
...
config.Data.outLFNDirBase = '/store/user/bkansal/step2/PGun_step2_DIGI_1200_2021_2_200_Sep17/'
