   ...
   if(isBarrel_) 
   {
	...
	counterBeta = beta;
	 ...
	 if( fabs(eta)>2.5) {
	   ...
	   etaPow = 0.103-0.053*(fabs(eta) - 2.0);
	   //etaPow = (fabs(eta) - 2.0);//*(fabs(eta) - 2.0)*(fabs(eta) - 2.0)*(fabs(eta) - 2.0);
	 }
	 /*
	 if (fabs(eta) < 2.5) {
	 ...
	 */
       ...
       else  // H hadrons here
	 {
	   ...
	   if( fabs(eta)<2.5) {
	     ...
	     etaPow = -1.1 + (fabs(eta) - 1.5)*(fabs(eta) - 1.5)*(fabs(eta) - 1.5)*(fabs(eta) - 1.5) ;
	     //etaPow = (fabs(eta) - 1.5)*(fabs(eta) - 1.5)*(fabs(eta) - 1.5)*(fabs(eta) - 1.5) ;
   ...
   for( unsigned entry = 0; entry < std::min((unsigned)50000000,(unsigned)(tree->GetEntriesFast()) ); entry++)
     {
       ...
       //if (fabs(eta_) < 1.5)
       //if (true_<50 || true_ > 200   ) continue;
       if(tree->GetBranchStatus("true"))
...
void calibChris() 
{
   ...
   */
   ...
   if(freezeparameters) {
     ...
     // fbEndcap
     functionEndcapEcalHcalC->FixParameter(0,-0.974251);
     functionEndcapEcalHcalC->FixParameter(1,1.61733);
     functionEndcapEcalHcalC->FixParameter(2,0.0629183);
     functionEndcapEcalHcalC->FixParameter(3,7.78495);
     functionEndcapEcalHcalC->FixParameter(4,-0.774289);
   ...
   if(freezeparameters) {
     ...
     //faEtaEndcapEH
     //spandey
     // functionEndcapAlphaEcalHcal->SetParameter(0,384.307);
     // functionEndcapAlphaEcalHcal->SetParameter(1,-384.305);
     // functionEndcapAlphaEcalHcal->SetParameter(2,2.16374e+08);

     functionEndcapAlphaEcalHcal->FixParameter(0,0.0112692);
     functionEndcapAlphaEcalHcal->FixParameter(1,-2.68063);
     // functionEndcapAlphaEcalHcal->SetParameter(2,4.51468e+14);
     functionEndcapAlphaEcalHcal->FixParameter(2,2.90973);   //it worked
     // functionEndcapAlphaEcalHcal->SetParameter(0,-1.0);
     // functionEndcapAlphaEcalHcal->SetParameter(3,10.0);

     
     //fbEtaEndcapEH
     functionEndcapBetaEcalHcal->FixParameter(0,-0.0192991);
     functionEndcapBetaEcalHcal->FixParameter(1,-0.265);
     functionEndcapBetaEcalHcal->FixParameter(2,80.5502);
     //functionEndcapBetaEcalHcal->SetParameter(3,57.1104);
     // functionEndcapBetaEcalHcal->SetParameter(0,-10);
     // functionEndcapBetaEcalHcal->SetParameter(1,100);
     //functionEndcapBetaEcalHcal->SetParameter(3,2);
