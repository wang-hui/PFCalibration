...
config.General.requestName = 'PGun_step3_RECO_902_200_500_Apr_28_Correct_tree'
...
config.Data.userInputFiles = open('/afs/cern.ch/user/s/spandey/work/public/PFHadronCalibration/CMSSW_9_0_2/src/PFCalibration/PFChargedHadronAnalyzer/test/step2_file_list_200_500.txt').readlines()
...
config.Data.outLFNDirBase = '/store/user/spandey/step3/PGun_step3_RECO_902_200_500_Apr_27_Correct_tree/'
