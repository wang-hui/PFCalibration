...
# with command line options: SinglePi0E10_pythia8_cfi --conditions auto:run1_mc -n 10 --eventcontent RAWSIM --relval 25000,100 -s GEN,SIM --datatier GEN-SIM --beamspot Realistic8TeVCollision --no_exec --conditions 92X_upgrade2017_realistic_forJetMET_HCALScaleStudies --era Run2_2017 --fileout file:step1.root
