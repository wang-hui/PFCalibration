...
config.General.requestName = 'PGun_step1_GEN_SIM_TEST_dec_15'
...
config.JobType.outputFiles = ['PGun_step1_GEN_SIM.root']
...
config.Data.outLFNDirBase = '/store/user/spandey/PGun_step1_GEN_SIM_TEST_dec_15/'
