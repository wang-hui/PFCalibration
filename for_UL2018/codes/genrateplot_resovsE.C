...
//  sprintf(hname1,"%s/%s_%s.root",path_root2,rootfile2,plot_name.c_str());
  ...
  if(xaxis_pt==false){
    sprintf(hname,"%s/%s_%s.root",path_root1,rootfile1,plot_name.c_str());
    sprintf(hname1,"%s/%s_%s.root",path_root2,rootfile2,plot_name.c_str());
    sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2018/plots/without_overlay/responseplots/pdf/%s_%s_reso.pdf",rootfile1,plot_name.c_str());
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2018/plots/without_overlay/responseplots/png/%s_%s_reso.png",rootfile1,plot_name.c_str());
    sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2018/plots/without_overlay/responseplots/gif/%s_%s_reso.gif",rootfile1,plot_name.c_str());
  }
    ...
    sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2018/plots/without_overlay/responseplots/pdf/%s_%s_pt_reso.pdf",rootfile1,plot_name.c_str());
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2018/plots/without_overlay/responseplots/png/%s_%s_pt_reso.png",rootfile1,plot_name.c_str());
    sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2018/plots/without_overlay/responseplots/gif/%s_%s_pt_reso.gif",rootfile1,plot_name.c_str());
  }
