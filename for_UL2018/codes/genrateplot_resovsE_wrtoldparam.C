...
//  sprintf(path_root2,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/trial1/response_plots_root/before15may");
  sprintf(path_root2,"/Users/bkansal/work/Ultra_legacy/final/for_UL2018/trial1/response_plots_root");
  sprintf(path_root1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2018/for_10_0_3/response_plots_root");
...
//  sprintf(hname1,"%s/%s_%s.root",path_root2,rootfile2,plot_name.c_str());
  ...
  if(xaxis_pt==false){
    ...
    sprintf(path,"/Users/bkansal/work/Ultra_legacy/final/for_UL2018/plots/overlay/overlay_wrtoldparam/responseplots/pdf/%s_%s_reso_wrtoldparam.pdf",rootfile2,plot_name.c_str());
    sprintf(path1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2018/plots/overlay/overlay_wrtoldparam/responseplots/png/%s_%s_reso_wrtoldparam.png",rootfile2,plot_name.c_str());
    sprintf(path2,"/Users/bkansal/work/Ultra_legacy/final/for_UL2018/plots/overlay/overlay_wrtoldparam/responseplots/gif/%s_%s_reso_wrtoldparam.gif",rootfile2,plot_name.c_str());
  }
    ...
    sprintf(path,"/Users/bkansal/work/Ultra_legacy/final/for_UL2018/plots/overlay/overlay_wrtoldparam/responseplots/pdf/%s_%s_pt_reso_wrtoldparam.pdf",rootfile1,plot_name.c_str());
    sprintf(path1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2018/plots/overlay/overlay_wrtoldparam/responseplots/png/%s_%s_pt_reso_wrtoldparam.png",rootfile1,plot_name.c_str());
    sprintf(path2,"/Users/bkansal/work/Ultra_legacy/final/for_UL2018/plots/overlay/overlay_wrtoldparam/responseplots/gif/%s_%s_pt_reso_wrtoldparam.gif",rootfile1,plot_name.c_str());
  }
