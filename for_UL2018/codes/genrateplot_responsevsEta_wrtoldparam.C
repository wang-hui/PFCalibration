...
void genrateplot_responsevsEta_wrtoldparam(string legendname,string plot_name, bool xaxis_pt)
{
...
//=========  (Mon Apr  1 19:35:54 2019) by ROOT version 6.14/06                                                                                                                   
  ...
  if(xaxis_pt==false){
    ...
    sprintf(path1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2018/plots/overlay/overlay_wrtoldparam/responseplots/png/%s_%s_wrtoldparam.png",rootfile1,plot_name.c_str());
    ...
    sprintf(hname,"%s/%s_%s_10_0_3_responseEta_pt.root",path_root1,rootfile1,plot_name.c_str());
    sprintf(hname1,"%s/%s_%s_10_6_0_pt.root",path_root2,rootfile2,plot_name.c_str());
    sprintf(path,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/responseplots/pdf/%s_%s_wrtoldparam.pdf",rootfile1,plot_name.c_str());
    sprintf(path1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/responseplots/png/%s_%s_wrtoldparam.png",rootfile1,plot_name.c_str());
    sprintf(path2,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/responseplots/gif/%s_%s_wrtoldparam.gif",rootfile1,plot_name.c_str());
  }
