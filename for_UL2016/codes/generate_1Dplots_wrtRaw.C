...
void generate_1Dplots_wrtRaw(string legendname,string plot_name)
{
  ...
  sprintf(hname1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/trial1/1D_response/correta_%s_10_6_0.root",plot_name.c_str());
  sprintf(hname,"/home/work/bhumika/work/calibration/Ultra_legacy/for_UL2016/raw/1D_response/Raw_%s_10_6_0_pre2_response.root",plot_name.c_str());
  sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/1D_responseplots/gif/%s",plot_name.c_str());
  sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/1D_responseplots/pdf/%s",plot_name.c_str());
  sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/1D_responseplots/png/%s",plot_name.c_str());
