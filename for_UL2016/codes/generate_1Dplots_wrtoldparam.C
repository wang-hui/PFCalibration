#include <stdio.h>
// #include<conio.h>
void generate_1Dplots_wrtoldparam(string legendname,string plot_name)
{
  ...
  sprintf(hname1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2016/trial1/1D_response/correta_%s_10_6_0.root",plot_name.c_str());
  sprintf(hname,"/Users/bkansal/work/Ultra_legacy/final/for_UL2016/for_10_0_3_calib/1D_response/correta_%s_10_0_3.root",plot_name.c_str());
  sprintf(path,"/Users/bkansal/work/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtoldparam/1D_responseplots/gif/%s",plot_name.c_str());
  sprintf(path1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtoldparam/1D_responseplots/pdf/%s",plot_name.c_str());
  sprintf(path2,"/Users/bkansal/work/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtoldparam/1D_responseplots/png/%s",plot_name.c_str());
  //  sprintf(new_rel,"new calib (10_6_0)");
  //sprintf(old_rel,"old calib (10_0_3)");
  sprintf(new_rel,"final correction (using new param)");
  sprintf(old_rel,"final correction (using old param)");
  ...
  for(int i=2; i<69;i++)
   ...
   //   ptstats_LaTex->SetTextSize(0.0255317);
   ...
   //   resp3->SetName(legendname.c_str());
