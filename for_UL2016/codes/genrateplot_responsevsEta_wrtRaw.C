...
void genrateplot_responsevsEta_wrtRaw(string legendname,string plot_name, bool xaxis_pt)
{
...
//=========  (Mon Apr  1 19:35:54 2019) by ROOT version 6.14/06                                                                                                                   
  ...
  sprintf(path_root2,"/home/work/bhumika/work/calibration/Ultra_legacy/for_UL2016/trial1/response_plots_root");
  ...
  if(xaxis_pt==false){
    ...
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/png/%s_%s_wrt%s.png",rootfile1,plot_name.c_str(),rootfile1);
    ...
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/png/%s_%s_pt_wrt%s.png",rootfile1,plot_name.c_str(),rootfile1);
