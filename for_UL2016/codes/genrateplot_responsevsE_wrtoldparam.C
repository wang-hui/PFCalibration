#include <stdio.h>
// #include<conio.h>
void genrateplot_responsevsE_wrtoldparam(string legendname, string plot_name, bool xaxis_pt=false)
{
...
//=========  (Mon Apr  1 19:35:54 2019) by ROOT version 6.14/06
  ...
  //  sprintf(path_root1,"/home/work/bhumika/work/calibration/Ultra_legacy/for_UL2017/trial1/response_plots_root/before15may");
  //  sprintf(path_root2,"/home/work/bhumika/work/calibration/Ultra_legacy/for_UL2017/trial1/response_plots_root/before15may");
  ...
  //  sprintf(path_root1,"/home/work/bhumika/work/calibration/Ultra_legacy/for_UL2017/raw/response_plots_root");
  //  sprintf(path_root2,"/home/work/bhumika/work/calibration/Ultra_legacy/for_UL2017/raw/response_plots_root");
  ...
  if(xaxis_pt==false){
    ...
    sprintf(path,"/Users/bkansal/work/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtoldparam/responseplots/pdf/%s_%s_wrtoldparam.pdf",rootfile2,plot_name.c_str());
    sprintf(path1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtoldparam/responseplots/png/%s_%s_wrtoldparam.png",rootfile2,plot_name.c_str());
    sprintf(path2,"/Users/bkansal/work/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtoldparam/responseplots/gif/%s_%s_wrtoldparam.gif",rootfile2,plot_name.c_str());
  }
    ...
    sprintf(path,"/Users/bkansal/work/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtoldparam/responseplots/pdf/%s_%s_pt_wrtoldparam.pdf",rootfile2,plot_name.c_str());
    sprintf(path1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtoldparam/responseplots/png/%s_%s_pt_wrtoldparam.png",rootfile2,plot_name.c_str());
    sprintf(path2,"/Users/bkansal/work/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtoldparam/responseplots/gif/%s_%s_pt_wrtoldparam.gif",rootfile2,plot_name.c_str());
  }
  ...
  // sprintf(new_rel,"%s",new_release);
   ...
   legends->AddEntry(graph1,"final correction (using old parameters)","P");//(name of hist,what you want it called in legend, l=line, p=polymarker, f=boxy thing ) 
