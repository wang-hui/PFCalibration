...
void generate_1Dplots(string legendname,string plot_name)
{
  ...
  sprintf(hname,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/trial1/1D_response/correta_%s_10_6_0.root",plot_name.c_str());
  sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/without_overlay/1D_responseplots/gif/%s",plot_name.c_str());
  sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/without_overlay/1D_responseplots/pdf/%s",plot_name.c_str());
  sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/without_overlay/1D_responseplots/png/%s",plot_name.c_str());
