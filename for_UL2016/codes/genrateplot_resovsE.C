...
//=========  (Mon Apr  1 19:35:54 2019) by ROOT version 6.14/06
  ...
  sprintf(path_root1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/trial1/response_plots_root");
...
//  sprintf(hname1,"%s/%s_%s.root",path_root2,rootfile2,plot_name.c_str());
  ...
  if(xaxis_pt==false){
    sprintf(hname,"%s/%s_%s.root",path_root1,rootfile1,plot_name.c_str());
    sprintf(hname1,"%s/%s_%s.root",path_root2,rootfile2,plot_name.c_str());
    sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/without_overlay/responseplots/pdf/%s_%s_reso.pdf",rootfile1,plot_name.c_str());
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/without_overlay/responseplots/png/%s_%s_reso.png",rootfile1,plot_name.c_str());
    sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/without_overlay/responseplots/gif/%s_%s_reso.gif",rootfile1,plot_name.c_str());
  }
    ...
    sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/without_overlay/responseplots/pdf/%s_%s_pt_reso.pdf",rootfile1,plot_name.c_str());
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/without_overlay/responseplots/png/%s_%s_pt_reso.png",rootfile1,plot_name.c_str());
    sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/without_overlay/responseplots/gif/%s_%s_pt_reso.gif",rootfile1,plot_name.c_str());
  }
  ...
  cout<<"file name --> "<<plot_name<<endl;
   ...
   legends->AddEntry(graph1,"for Ultralegacy 2016","P");//(name of hist,what you want it called in legend, l=line, p=polymarker, f=boxy thing )
