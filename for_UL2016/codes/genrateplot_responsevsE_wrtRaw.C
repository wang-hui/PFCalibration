#include <stdio.h>
// #include<conio.h>
void genrateplot_responsevsE_wrtRaw(string legendname, string plot_name, bool xaxis_pt=false)
{
...
//=========  (Mon Apr  1 19:35:54 2019) by ROOT version 6.14/06
  ...
  if(xaxis_pt==false){
    ...
    sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/pdf/%s_%s_wrt%s.pdf",rootfile2,plot_name.c_str(),rootfile1);
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/png/%s_%s_wrt%s.png",rootfile2,plot_name.c_str(),rootfile1);
    sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/gif/%s_%s_wrt%s.gif",rootfile2,plot_name.c_str(),rootfile1);
  }
    ...
    sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/pdf/%s_%s_pt_wrt%s.pdf",rootfile2,plot_name.c_str(),rootfile1);
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/png/%s_%s_pt_wrt%s.png",rootfile2,plot_name.c_str(),rootfile1);
    sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/gif/%s_%s_pt_wrt%s.gif",rootfile2,plot_name.c_str(),rootfile1);
  }
  ...
  // sprintf(new_rel,"%s",new_release);
   ...
   TLegend* legends = new TLegend(0.49, 0.7, 0.9, 0.9,"","brNDC"); // the numbers determine the position of the box 
