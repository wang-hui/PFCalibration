#include <stdio.h>
// #include<conio.h>
void genrateplot_resovsE_wrtRaw(string legendname, string plot_name, bool xaxis_pt)
{
...
//=========  (Mon Apr  1 19:35:54 2019) by ROOT version 6.14/06
  ...
  sprintf(path_root1,"/home/work/bhumika/work/calibration/Ultra_legacy/for_UL2016/raw/response_plots_root");
  sprintf(path_root2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/trial1/response_plots_root");
...
//  sprintf(hname1,"%s/%s_%s.root",path_root2,rootfile2,plot_name.c_str());
  ...
  if(xaxis_pt==false){
    sprintf(hname,"%s/%s_%s_pre2_response.root",path_root1,rootfile1,plot_name.c_str());
    sprintf(hname1,"%s/%s_%s.root",path_root2,rootfile2,plot_name.c_str());
    sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/pdf/%s_%s_reso_wrt%s.pdf",rootfile2,plot_name.c_str(),rootfile1);
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/png/%s_%s_reso_wrt%s.png",rootfile2,plot_name.c_str(),rootfile1);
    sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/gif/%s_%s_reso_wrt%s.gif",rootfile2,plot_name.c_str(),rootfile1);
  }
    ...
    sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/pdf/%s_%s_pt_reso.pdf",rootfile1,plot_name.c_str());
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/png/%s_%s_pt_reso.png",rootfile1,plot_name.c_str());
    sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2016/plots/overlay/overlay_wrtRaw/responseplots/gif/%s_%s_pt_reso.gif",rootfile1,plot_name.c_str());
  }
  ...
  cout<<"file name --> "<<plot_name<<endl;
   ...
   TLegend* legends = new TLegend(0.40, 0.7, 0.9, 0.9,"","brNDC"); // the numbers determine the position of the box
