...
//=========  (Mon Apr  1 19:35:54 2019) by ROOT version 6.14/06                                                                                                                   
  ...
  if(xaxis_pt==false){
    ...
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtRaw/responseplots/png/%s_%s_wrt%s.png",rootfile1,plot_name.c_str(),rootfile1);
    ...
    sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2017/plots/without_overlay/responseplots/pdf/%s_%s_pt.pdf",rootfile1,plot_name.c_str());
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2017/plots/without_overlay/responseplots/png/%s_%s_pt.png",rootfile1,plot_name.c_str());
    sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2017/plots/without_overlay/responseplots/gif/%s_%s_pt.gif",rootfile1,plot_name.c_str());
  }
