...
//=========  (Mon Apr  1 19:35:54 2019) by ROOT version 6.14/06
  ...
  if(xaxis_pt==false){
    ...
    sprintf(path,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/responseplots/pdf/%s_%s_wrtoldparam.pdf",rootfile2,plot_name.c_str());
    sprintf(path1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/responseplots/png/%s_%s_wrtoldparam.png",rootfile2,plot_name.c_str());
    sprintf(path2,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/responseplots/gif/%s_%s_wrtoldparam.gif",rootfile2,plot_name.c_str());
  }
    ...
    sprintf(path,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/responseplots/pdf/%s_%s_pt_wrtoldparam.pdf",rootfile2,plot_name.c_str());
    sprintf(path1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/responseplots/png/%s_%s_pt_wrtoldparam.png",rootfile2,plot_name.c_str());
    sprintf(path2,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/responseplots/gif/%s_%s_pt_wrtoldparam.gif",rootfile2,plot_name.c_str());
  }
