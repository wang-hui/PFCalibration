#include <stdio.h>
// #include<conio.h>
void generate_1Dplots(string legendname,string plot_name)
{
  ...
  sprintf(hname,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2017/trial1/1D_response/before15may/correta_%s_10_6_0_pre2.root",plot_name.c_str());
  sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2017/plots/without_overlay/1D_responseplots/gif/%s",plot_name.c_str());
  sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2017/plots/without_overlay/1D_responseplots/pdf/%s",plot_name.c_str());
  sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2017/plots/without_overlay/1D_responseplots/png/%s",plot_name.c_str());
