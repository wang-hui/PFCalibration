...
void genrateplot_responsevsEta(string legendname,string plot_name, bool xaxis_pt)
{
...
//=========  (Mon Apr  1 19:35:54 2019) by ROOT version 6.14/06                                                                                                                   
  ...
  if(xaxis_pt==false){
    ...
    sprintf(path,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2017/plots/without_overlay/responseplots/pdf/%s_%s.pdf",rootfile1,plot_name.c_str());
    sprintf(path1,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2017/plots/without_overlay/responseplots/png/%s_%s.png",rootfile1,plot_name.c_str());
    sprintf(path2,"/home/work/bhumika/work/calibration/Ultra_legacy/final/for_UL2017/plots/without_overlay/responseplots/gif/%s_%s.gif",rootfile1,plot_name.c_str());
  }
