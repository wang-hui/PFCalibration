...
void generate_1Dplots_wrtoldparam(string legendname,string plot_name)
{
  ...
  sprintf(hname,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/trial_oldparam/1D_response/correta_%s_10_6_0_pre2.root",plot_name.c_str());
  sprintf(path,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/1D_responseplots/gif/%s",plot_name.c_str());
  sprintf(path1,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/1D_responseplots/pdf/%s",plot_name.c_str());
  sprintf(path2,"/Users/bkansal/work/Ultra_legacy/final/for_UL2017/plots/overlay/overlay_wrtoldparam/1D_responseplots/png/%s",plot_name.c_str());
