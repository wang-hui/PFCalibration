...
//=========  (Mon Apr  1 19:35:54 2019) by ROOT version 6.14/06
  ...
  sprintf(rootfile1,"corr");
  sprintf(rootfile2,"corr");
  ...
  sprintf(path,"../overlay_response_plots/without_overlay/pdf/%s_%s.pdf",rootfile1,plot_name);
  sprintf(path1,"../overlay_response_plots/without_overlay/png/%s_%s.png",rootfile1,plot_name);
  sprintf(path2,"../overlay_response_plots/without_overlay/gif/%s_%s.gif",rootfile1,plot_name);
