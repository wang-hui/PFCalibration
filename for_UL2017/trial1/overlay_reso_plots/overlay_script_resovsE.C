...
//=========  (Mon Apr  1 19:35:54 2019) by ROOT version 6.14/06
  ...
  sprintf(plot_name, "H_barrel_10_6_0_pre2_pt");//correta_H_barrel_10_6_0_pre2_pt.root
  ...
  sprintf(hname,"/home/work/bhumika/work/calibration/Ultra_legacy/for_UL2017/output1.root");
  ...
  sprintf(path,"../../overlay_response_plots/witholdparam_pdf/%s_%s.png",rootfile1,plot_name);
  ...
  // sprintf(new_rel,"%s",new_release);
   ...
   legends->AddEntry(graph1,"raw","P");//(name of hist,what you want it called in legend, l=line, p=polymarker, f=boxy thing ) 
