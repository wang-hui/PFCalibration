...
void generate_1Dplots()
{
  ...
  for(int i=2; i<20;i++)
    { 
      ...
      sprintf(hname,"corrEta_H_barrel_etagre1_res.root");
      sprintf(hname1,"corrEta_H_barrel_eta1_res.root");
      ...
      sprintf(path,"foreta1_etagre1_H_barrel/%s.gif",hist_name);
