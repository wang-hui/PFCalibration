...
# with command line options: step3 --runUnscheduled --conditions auto:run2_mc -s RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT,VALIDATION:@standardValidationNoHLT+@miniAODValidation,DQM:@standardDQMFakeHLT+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO -n 10 --era Run2_2016 --eventcontent RECOSIM,MINIAODSIM,DQM --filein file:step2.root --fileout file:step3.root
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_unity_nooffset.root'),
...
### To use PFcalibration parameters and functions from payload ##################
# process.GlobalTag.globaltag = 'auto'
process.particleFlowTmp.useCalibrationsFromDB = True

process.GlobalTag.toGet = cms.VPSet(
    cms.PSet(record = cms.string("PFCalibrationRcd"),
#             tag = cms.string("PFCalibration2019_mc_UL2017"),
             tag = cms.string("PFCalibration_unity"),
             # tag = cms.string("PFCalibration_v10_mc"),
             # tag = cms.string("PFCalibration_HLT_2017_25ns_Spring17_V4_newCodeCompliant"),
             #connect = cms.string("sqlite_file:/afs/cern.ch/user/b/bkansal/work/PFcalibration_2019/UL2016/CMSSW_11_0_0_pre7/src/PFCalibration_UL2017.db")
            connect = cms.string("sqlite_file:/afs/cern.ch/user/b/bkansal/work/PFcalibration_2019/UL2016/CMSSW_11_0_0_pre7/src/PFCalibration_unity.db")
#             connect = cms.string("sqlite_file:/afs/cern.ch/user/b/bkansal/work/PFcalibration_2019/CMSSW_10_6_X_2019-05-13-2300/src/PFCalibration.db")
             # connect = cms.string("sqlite_file:/afs/cern.ch/user/b/bkansal/work/PFcalibration_2019/CMSSW_10_6_0/src/PFCalibration.db")
             )
    )
